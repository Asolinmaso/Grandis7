...
export default function AboutGrandis7() {
  return (
    <section className="w-full bg-white pt-32 pb-16 lg:pt-36 lg:pb-20 max-md:bg-[#FAFAFA]">
      <div className="max-w-7xl mx-auto px-12 lg:px-14 xl:px-16">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 lg:gap-8">
          ...
          <div className="flex-1 lg:max-w-2xl xl:max-w-3xl max-md:text-center max-md:flex max-md:flex-col max-md:items-center">
            <p className="text-sm md:text-base font-semibold uppercase tracking-[0.24em] text-[#686868] mb-2 max-md:text-[16px] max-md:leading-[22px] max-md:tracking-[0.24em] max-md:font-light">
              ABOUT GRANDIS7
            </p>
            ...
            <p className="text-gray-700 text-sm md:text-base lg:text-lg leading-relaxed mt-4 md:mt-6 max-w-xl max-md:text-center max-md:text-[20px] max-md:leading-[27px] max-md:text-[#686868] max-md:max-w-[393px]">
            ...
            <Link
              href="/about"
              className="inline-block mt-4 md:mt-6 px-6 md:px-8 py-3 md:py-4 text-[#421F00] rounded-lg font-semibold hover:opacity-90 transition-opacity text-sm md:text-base max-md:py-3 max-md:px-4 max-md:text-[16px] max-md:leading-[22px] max-md:font-normal max-md:shadow-[0px_4px_4px_rgba(0,0,0,0.25)]"
              style={{
                background:
          ...
          <div className="flex gap-3 md:gap-4 lg:gap-0 justify-center lg:justify-end max-md:bg-[#CEEFFF] max-md:rounded-2xl max-md:p-4 max-md:gap-4 max-md:w-full max-md:max-w-[440px] max-md:mx-auto">
            ...
            {/* Large Image */}
            <div className="relative w-[160px] sm:w-[180px] md:w-[220px] lg:w-[280px] lg:-ml-16 h-[200px] sm:h-[240px] md:h-[300px] lg:h-[380px] rounded-lg overflow-hidden max-md:flex-1 max-md:min-h-[280px] max-md:rounded-2xl">
              <Image
