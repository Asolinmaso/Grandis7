            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    href="#"
                    className="w-10 h-10 rounded-full border-2 border-[#D4AF37] flex items-center justify-center text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#421F00] transition-colors"
                    aria-label="Facebook"
                  >
                    <svg
                      className="w-5 h-5"
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 max-md:space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-[#D4AF37] text-sm max-md:text-white max-md:text-[20px] max-md:leading-[27px]">+91 - 9600663389</span>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-[#D4AF37] text-sm max-md:text-white max-md:text-[20px] max-md:leading-[27px]">contact@grandis7.com</span>
                </div>
                <div className="flex items-start gap-3">
